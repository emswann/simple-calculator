...
public class CalculatorController implements Calculator {
  ...
  @GetMapping("/add")
  public ResponseEntity<Equation> add(@RequestParam(value="param1", required=true) String param1, @RequestParam(value="param2", required=true) String param2)
  {
	try {
  ...
  @GetMapping("/subtract")
  public ResponseEntity<Equation> subtract(@RequestParam(value="param1", required=true) String param1, @RequestParam(value="param2", required=true) String param2) {
	try {
  ...
  @GetMapping("/multiply")
  public ResponseEntity<Equation> multiply(@RequestParam(value="param1", required=true) String param1, @RequestParam(value="param2", required=true) String param2) {
	try {
  ...
  @GetMapping("/divide")
  public ResponseEntity<Equation> divide(@RequestParam(value="param1", required=true) String param1, @RequestParam(value="param2", required=true) String param2) {
	try {
